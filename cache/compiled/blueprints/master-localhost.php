...
return [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.blackhole.output_path' => [
                'type' => 'text',
                'label' => 'Output Path',
                'name' => 'plugins.blackhole.output_path',
                'validation' => 'strict'
            ],
            'plugins.blackhole.force' => [
                'type' => 'toggle',
                'label' => 'Force',
                'highlight' => 1,
                'default' => 0,
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'blackhole' => [
                    ...
                    'output_path' => 'plugins.blackhole.output_path',
                    'force' => 'plugins.blackhole.force'
                ],
                'email' => [
